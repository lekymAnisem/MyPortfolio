...
<html>
<head>
    <title>Admin - PrimeWater Quezon Metro</title>
    <meta charset="utf-8">
...
<header class="site-header">
    <div class="container">
        ...
        <div class="header-actions">
            <a href="login.php" class="btn-portal"><i class="fas fa-user"></i> User Login</a>
        </div>
    </div>
</header>
        ...
        <div class="form-container" style="max-width:480px;">
            <form method="POST">
                <div class="form-group">
                    <label for="user"><i class="fas fa-user-shield"></i> Username</label>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary btn-lg" name="loginAdmin" style="width:100%;justify-content:center;">Log In</button>
                </div>
                <div style="text-align:center;margin-top:20px;">
                    <a href="login.php" style="font-size:13px;">User Login</a>
                </div>
            </form>
        </div>
    </div>
