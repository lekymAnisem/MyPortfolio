...
<header class="site-header">
    <div class="container">
        ...
        <div class="logo">
            <a href="usermain.php"><img src="images/prime.jpg" alt="PrimeWater Quezon Metro"></a>
        </div>
        <nav class="main-nav">
            <ul>
...
<section class="hero-carousel" id="hero">
    <div class="slide active" style="background-image: url('images/header.jpg');">
        ...
        <div class="slide-content">
            ...
            <p><strong>The PrimeWater Mission:</strong> To provide potable, reliable, and sustainable water to Filipino communities.<br><strong>The PrimeWater Vision:</strong> To be one of the country's premier water utility companies.</p>
        </div>
    </div>
    <div class="slide" style="background-image: url('images/header2.jpg');">
        ...
        <div class="slide-content">
            ...
            <p>Delivering clean, safe water to every household and business in Quezon Metro.</p>
        </div>
    </div>
    <div class="slide" style="background-image: url('images/header4.jpg');">
        ...
        <div class="slide-content">
            ...
            <p>Your satisfaction is our priority with easy online services and responsive support.</p>
        </div>
    </div>
    <div class="slide" style="background-image: url('images/header5.jpg');">
        ...
        <div class="slide-content">
            ...
            <p>Our team is always ready to assist you. Hotline: 1626</p>
        </div>
    </div>
    <div class="slide" style="background-image: url('images/header6.jpg');">
        ...
        <div class="slide-content">
            ...
            <p>Working together for potable, reliable, and sustainable water for all.</p>
        </div>
    </div>
    <div class="slide" style="background-image: url('images/header7.jpg');">
        ...
        <div class="slide-content">
            ...
            <p>Serving you with excellence — to be one of the country's premier water utility companies.</p>
        </div>
    </div>
...
<section class="content-section">
    <div class="container">
        <div class="section-title">
            <h2>Our Services</h2>
            <p>Explore the range of services we offer to our valued customers.</p>
            <div class="title-bar"></div>
        </div>
        <div class="cards-grid">
            <div class="card">
                ...
                <h3>Application</h3>
                <p>Apply for a new water connection or manage your existing applications online.</p>
                <a href="application.php" class="btn btn-accent">Apply Now</a>
            </div>
            <div class="card">
                <div class="card-icon"><i class="fas fa-exclamation-triangle"></i></div>
                <h3>Complaint</h3>
                <p>Report a water service issue and track the status of your complaints.</p>
                <a href="complaint.php" class="btn btn-accent">File a Complaint</a>
            </div>
            <div class="card">
                <div class="card-icon"><i class="fas fa-file-invoice-dollar"></i></div>
                <h3>Bill</h3>
                <p>View your billing history and check your current water bill details.</p>
                <a href="mybill.php" class="btn btn-accent">View Bill</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="two-col">
            <div class="col">
                ...
                <h2>Reliable Water Service</h2>
                <p>We are committed to delivering clean, safe, and reliable water to every household and business in Quezon Metro.</p>
            </div>
            <div class="col">
                <img src="images/pic02.jpg" alt="">
                <h2>Customer-Centric Approach</h2>
                <p>Your satisfaction is our priority. From easy online applications to responsive complaint handling.</p>
            </div>
        </div>
    </div>
</section>
