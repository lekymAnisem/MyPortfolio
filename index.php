...
<header class="site-header">
    <div class="container">
        <button class="navbar-toggle" onclick="document.querySelector('.main-nav ul').classList.toggle('open')">
        ...
        <div class="header-actions">
            ...
            <a href="login.php" class="btn-portal"><i class="fas fa-user-circle"></i> My Account</a>
        </div>
    </div>
</header>
...
<section class="hero-carousel" id="hero">
    <div class="slide active" style="background-image: url('images/header.jpg');">
        ...
        <div class="slide-content">
            ...
            <p><strong>Mission:</strong> To provide potable, reliable, and sustainable water to Filipino communities.<br><strong>Vision:</strong> To be one of the country's premier water utility companies.</p>
            <a href="login.php" class="btn btn-white btn-lg">Get Started</a>
        </div>
    </div>
    <div class="slide" style="background-image: url('images/header2.jpg');">
        <div class="slide-overlay"></div>
        <div class="slide-content">
            <h2>Reliable Water Service</h2>
            <p>Delivering clean, safe water to every household and business in Quezon Metro with modern infrastructure and minimal service interruptions.</p>
        </div>
    </div>
    <div class="slide" style="background-image: url('images/header4.jpg');">
        ...
        <div class="slide-content">
            ...
            <p>Your satisfaction is our priority. From easy online applications to responsive complaint handling, we make every effort to provide a seamless experience.</p>
        </div>
    </div>
    <div class="slide" style="background-image: url('images/header5.jpg');">
        ...
        <div class="slide-content">
            ...
            <p>Our team is always ready to assist you with any water service concerns. Hotline: 1626</p>
        </div>
    </div>
    <div class="slide" style="background-image: url('images/header6.jpg');">
        ...
        <div class="slide-content">
            ...
            <p>Working together with Filipino communities to provide potable, reliable, and sustainable water for all.</p>
        </div>
    </div>
    <div class="slide" style="background-image: url('images/header7.jpg');">
        ...
        <div class="slide-content">
            ...
            <p>To be one of the country's premier water utility companies — serving you with excellence.</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="bill-calculator">
            ...
            <div class="calc-results" id="calcResults" style="display:none;">
                <h3><i class="fas fa-file-invoice"></i> Your Bill Summary</h3>
                <table>
                    <thead>
                        <tr>
                            <th>Description</th>
...
<section class="content-section">
    <div class="container">
        <div class="section-title">
            <h2>Our Services</h2>
            <p>We provide quality water services to our community</p>
            <div class="title-bar"></div>
        </div>
        <div class="cards-grid">
            <div class="card">
                ...
                <p>Apply for new connections, sub-connections, transfers, and more.</p>
                <a href="application.php" class="btn btn-outline">Learn More</a>
            </div>
            <div class="card">
                <div class="card-icon"><i class="fas fa-exclamation-triangle"></i></div>
                <h3>Report Complaint</h3>
                <p>Report issues like leaking pipes, no water, dirty water, and more.</p>
                <a href="complaint.php" class="btn btn-outline">Learn More</a>
            </div>
            <div class="card">
                <div class="card-icon"><i class="fas fa-file-invoice-dollar"></i></div>
                <h3>Billing & Payment</h3>
                <p>View your bills, check payment history, and manage your account.</p>
    ...
    <div class="container">
        <div class="two-col">
            <div class="col">
                ...
                <h2>Reliable Water Service</h2>
                <p>We are committed to delivering clean, safe, and reliable water to every household and business in Quezon Metro. Our modern infrastructure ensures minimal service interruptions and consistent water quality.</p>
            </div>
            <div class="col">
                <img src="images/pic02.jpg" alt="">
                <h2>Customer-Centric Approach</h2>
                <p>Your satisfaction is our priority. From easy online applications to responsive complaint handling, we make every effort to provide a seamless experience for all our customers.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="explore-section">
    <div class="container">
        <div class="section-title">
            <h2>Explore PrimeWater</h2>
            <p>Discover our range of services and solutions</p>
            <div class="title-bar"></div>
        </div>
        <div class="explore-grid">
            <div class="explore-card">
                <span class="ec-icon"><i class="fas fa-home"></i></span>
                <h3>For Homes</h3>
                <p>Residential water services</p>
            </div>
            <div class="explore-card">
                <span class="ec-icon"><i class="fas fa-building"></i></span>
                <h3>For Business</h3>
                <p>Commercial water solutions</p>
            </div>
            <div class="explore-card">
                <span class="ec-icon"><i class="fas fa-industry"></i></span>
                <h3>For Enterprise</h3>
                <p>Large-scale water supply</p>
            </div>
        </div>
    </div>
</section>
...
<section class="quote-section">
    <div class="container">
        <blockquote>&ldquo;Providing potable, reliable, and sustainable water to Filipino communities — one drop at a time.&rdquo;</blockquote>
    </div>
</section>
