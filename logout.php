...
<html>
<head>
    <title>Logged Out - PrimeWater Quezon Metro</title>
    <meta charset="utf-8">
...
<section class="content-section" style="min-height:50vh;display:flex;align-items:center;">
    <div class="container">
        <div style="max-width:500px;margin:0 auto;text-align:center;padding:40px;">
            <div style="font-size:64px;color:var(--primary);margin-bottom:20px;"><i class="fas fa-check-circle"></i></div>
            <h2 style="color:var(--primary);margin-bottom:12px;">You've been logged out</h2>
            <p style="color:var(--gray-500);">Redirecting you to the homepage...</p>
        </div>
    </div>
</section>
